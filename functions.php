...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('slick', get_template_directory_uri() . '/assets/bower/slick-carousel/slick/slick.min.js', array('jquery'), '1.0.0'); // Slick
        wp_enqueue_script('slick'); // Enqueue it!

        wp_register_script('html5blankscripts', get_template_directory_uri() . '/js/scripts.js', array('jquery'), '1.0.0'); // Custom scripts
        wp_enqueue_script('html5blankscripts'); // Enqueue it!

        wp_register_script('font-awesome', 'https://use.fontawesome.com/releases/v5.0.0/js/all.js', array('jquery'), '5.0.0'); // Custom scripts
...
{
    wp_register_style('html5blank', get_template_directory_uri() . '/assets/css/main/style.min.css', array(), '1.0', 'all');
...
// Import a php file here to handle this separately
