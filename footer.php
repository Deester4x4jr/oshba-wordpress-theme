	...
	<footer class="footer">
	    ...
	    <div class="container">
			...
			<div class="field is-grouped is-grouped-centered" style="margin-bottom: 2rem;">
        		<p class="control">
				    <a class="button is-white" target="_blank" href="/blog">
				        <span>Blog</span>
				    </a>
				</p>
				<p class="control">
				    <a class="button is-white" target="_blank" href="/events">
				        <span>Events</span>
				    </a>
				</p>
				<p class="control">
				    <a class="button is-white" target="_blank" href="/resources">
				        <span>Resources</span>
				    </a>
				</p>
				<p class="control">
				    <a class="button is-white" target="_blank" href="/contact-us">
